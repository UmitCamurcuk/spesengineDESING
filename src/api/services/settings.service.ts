...
import type { ApiSuccessResponse, AppSettings, SettingsPatchRequest } from '../types/api.types';
...
export const settingsService = {
  ...
  async updateSettings(payload: SettingsPatchRequest): Promise<AppSettings> {
